...
const Details = () => {
    ...
    const onSubmit = data => {
        axios.post('https://car-rental-server-site-production.up.railway.app/details', data)
            .then(res => {
                console.log(res);
    ...
    useEffect(() => {
        fetch(`https://car-rental-server-site-production.up.railway.app/products/${id}`)
            .then(res => res.json())
